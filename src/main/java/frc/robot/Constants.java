...
public final class Constants {
  ...
  public static final class SwerveConstants {
    ...
    public static final double k_AngularVelocity = (1.8);
    ...
    public static final double k_WFLOffset = 130; 
    public static final double k_WFROffset = 133;
    public static final double k_WRLOffset = 130;
    public static final double k_WRROffset = 130;
